...
![image-20210618000911136](./image-20210618000911136.png)
...
1.  **保证一个类只有一个实例。**为什么会有人想要控制一个类的实例数量呢？最常见的原因是控制某些共享资源（例如数据库或文件）的访问权限。
    ...
    ![image-20210618002037183](./image-20210618002037183.png)
...
![image-20210618004658269](./image-20210618004658269.png)
